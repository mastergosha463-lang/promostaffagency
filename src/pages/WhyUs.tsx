...
const WhyUs = () => {
  ...
  useSEO({
    title:
      language === "RU"
        ? "Почему ALEX CLOUD — агентство персонала для мероприятий в Москве"
        : "Why ALEX CLOUD — event staffing agency in Moscow",
    description:
      language === "RU"
        ? "Опытная команда, 99% доходимость, мобилизация до 40 человек за 24 часа. ALEX CLOUD — надёжность в каждой детали события."
        : "Experienced team, 99% arrival rate, up to 40 staff mobilised in 24 hours. ALEX CLOUD — reliability in every detail.",
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground mt-4 max-w-2xl mx-auto text-lg">
              {language === "RU" 
                ? "ALEX CLOUD — надёжность в каждой детали события"
                : "ALEX CLOUD — reliability in every detail of your event"}
            </p>
          </div>
